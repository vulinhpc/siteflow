...
import { AlertTriangle, CalendarIcon, Save, Send, Upload, X } from 'lucide-react';
    ...
    return (
      <Card>
        <CardContent className="p-8 text-center">
          ...
          <h3 className="mb-2 text-lg font-medium">{tCreate('permissionDenied')}</h3>
...
? (
                <div className="rounded-lg border-2 border-dashed border-muted-foreground/25 p-8 text-center">
                  ...
                  <p className="mb-1 text-sm text-muted-foreground">{tCreate('noMedia')}</p>
