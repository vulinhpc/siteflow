...
import { AlertTriangle, Calendar, FileText, FolderOpen, Image, Star, User } from 'lucide-react';
...
media
                  ...
                  {log.review_comment && (
                    <div className="space-y-2">
                      ...
                      <div className="rounded-lg bg-muted/50 p-3 pl-6">
                  ...
                  <div className="space-y-3 border-t pt-2">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-xs text-muted-foreground">
                        {t('approvedAt')}
:
{format(new Date(log.approved_at), 'MMM dd, HH:mm')}
                      </div>
                    </div>
...
? (
                      <div className="flex items-center gap-3">
                        ...
                        <Badge variant="outline" className="bg-yellow-50 text-xs text-yellow-800">
                          ⭐
{' '}
{log.qc_rating}
/5
